...
export const WhatsAppButton: React.FC = () => {
    return (
        ...
        >
            ...
            {/* Glow Effect */}
            <div className="absolute inset-0 bg-[#25D366] rounded-full blur-2xl opacity-40 group-hover:opacity-70 transition-opacity duration-500" />

            {/* Button Body */}
            <div className="relative bg-[#25D366] p-4 rounded-full shadow-[0_20px_50px_rgba(37,211,102,0.4)] group-hover:shadow-[0_25px_60px_rgba(37,211,102,0.6)] hover:scale-110 active:scale-95 transition-all duration-300 flex items-center justify-center border-2 border-white/20">
                <svg
                    viewBox="0 0 24 24"
                    width="32"
                    height="32"
